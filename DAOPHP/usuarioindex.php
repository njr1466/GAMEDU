...
$app->get('/queryAll/:id','queryAll');
$app->get('/queryAllOrderBy/:orderColumn','queryAll');
$app->get('/queryAll/:id','queryAll');
	...
	public function delete($${pk}){
		$sql = 'DELETE FROM Usuario WHERE ${pk} = ?';
		$sqlQuery = new SqlQuery($sql);
	...
	public function insert($${var_name}){
		$sql = 'INSERT INTO Usuario (${insert_fields}) VALUES (${question_marks})';
		$sqlQuery = new SqlQuery($sql);
		${parameter_setter}
	...
	public function update($${var_name}){
		$sql = 'UPDATE Usuario SET ${update_fields} WHERE ${pk} = ?';
		$sqlQuery = new SqlQuery($sql);
		${parameter_setter}
