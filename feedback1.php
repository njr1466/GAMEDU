...
<!--CONTEUDO AQUI -->
       <div class="row" style="">
    <div class="col-md-10 ">
      <form id="formpush" class="form-horizontal" role="form" method="POST" action="pushfeedback.php" >
        <fieldset>
          <!-- Form Name -->
          ...
          <div class="form-group">
            <div class="col-sm-offset-1 col-sm-10">
              <div class="pull-right">
                ...
                <button type="button" id="btnpush" name="btnpush" class="btn btn-primary">ENVIAR PUSH</button>
              </div>
            </div>
          </div>
