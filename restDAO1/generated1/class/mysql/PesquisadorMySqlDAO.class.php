...
class PesquisadorMySqlDAO implements PesquisadorDAO{
	...
	public function load($id){
		$sql = 'SELECT * FROM pesquisador WHERE siape = ?';
	...
	public function insert($pesquisador){
		$sql = 'INSERT INTO pesquisador (cpf, nome, cargo, titulacao, sexo, regime, campus_id, departamento_id, telefone, celular, email1, email2, linklattes, area_codigo) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
		$sqlQuery = new SqlQuery($sql);
