...
class PlanoAtivAvaliacaoMySqlDAO implements PlanoAtivAvaliacaoDAO{
	...
	public function insert($planoAtivAvaliacao){
		$sql = 'INSERT INTO plano_ativ_avaliacao (nota, comentario, data_envio_plano, data_avaliacao, proposta_bolsa_id, avaliador_id,qtd) VALUES (?, ?, ?, ?, ?, ?, ?)';
		$sqlQuery = new SqlQuery($sql);
		...
		$sqlQuery->setNumber($planoAtivAvaliacao->avaliadorId);
                $sqlQuery->setNumber($planoAtivAvaliacao->qtd);
	...
	public function update($planoAtivAvaliacao){
		$sql = 'UPDATE plano_ativ_avaliacao SET nota = ?, comentario = ?, data_envio_plano = ?, data_avaliacao = ?, qtd = ? WHERE proposta_bolsa_id = ?  AND avaliador_id = ? ';
		$sqlQuery = new SqlQuery($sql);
