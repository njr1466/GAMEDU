...
class OfertasMySqlDAO implements OfertasDAO{
	...
	public function insert($oferta){
		$sql = 'INSERT INTO ofertas (id_cliente, id_categoria, promocao, promocaocompleta, valorantigo, valor, desconto, qtd, inicio_cupom, datainicial, datafinal, descricao, regulamento, foto1, foto2, foto3, patrocinador, mapa, ativo, principal, principalcategoria, datacriacao, observacao) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
		$sqlQuery = new SqlQuery($sql);
	...
	public function update($oferta){
		$sql = 'UPDATE ofertas SET id_cliente = ?, id_categoria = ?, promocao = ?, promocaocompleta = ?, valorantigo = ?, valor = ?, desconto = ?, qtd = ?, inicio_cupom = ?, datainicial = ?, datafinal = ?, descricao = ?, regulamento = ?, foto1 = ?, foto2 = ?, foto3 = ?, patrocinador = ?, mapa = ?, ativo = ?, principal = ?, principalcategoria = ?, datacriacao = ?, observacao = ? WHERE id = ?';
		$sqlQuery = new SqlQuery($sql);
	...
	public function queryByInicioCupom($value){
		$sql = 'SELECT * FROM ofertas WHERE inicio_cupom = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByRegulamento($value){
		$sql = 'SELECT * FROM ofertas WHERE regulamento = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByPatrocinador($value){
		$sql = 'SELECT * FROM ofertas WHERE patrocinador = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->getList($sqlQuery);
	}
	...
	public function deleteByInicioCupom($value){
		$sql = 'DELETE FROM ofertas WHERE inicio_cupom = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByRegulamento($value){
		$sql = 'DELETE FROM ofertas WHERE regulamento = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByPatrocinador($value){
		$sql = 'DELETE FROM ofertas WHERE patrocinador = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
